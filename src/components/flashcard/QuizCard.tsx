    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      {type === "mcq" ? (
        <div className="flex flex-col items-center gap-2 text-center">
          <p className="text-3xl font-extrabold text-slate-900">{card.term}</p>
          {!!card.phonetic && (
            <p className="text-slate-500">{card.phonetic}</p>
          )}
        ...
        <div className="flex flex-col items-center gap-1 text-center">
          ...
          {!!card.part_of_speech && (
            <p className="text-sm text-slate-400">({card.part_of_speech})</p>
          )}
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          <button
            type="button"
            onClick={say}
            className="flex h-20 w-20 items-center justify-center rounded-full bg-brand-light text-brand-dark hover:bg-brand/20"
            aria-label="Nghe lại"
          >
      ...
      {answered && (
        ...
        >
          ...
          {type !== "mcq" && !!card.meaning_vi && (
            <p className="mt-0.5 text-sm text-slate-500">{card.meaning_vi}</p>
          )}
        </div>
      )}
