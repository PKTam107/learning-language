...
async function assertNoDuplicate(
  ...
  if (rows.some((c: any) => normalizeTerm(c.term) === normalized)) {
...
/**
 * Nhập hàng loạt DraftCard vào deck (import Excel). Bỏ qua từ trùng (chuẩn hóa) —
 * cả trùng với từ đã có lẫn trùng trong chính lô nhập. Trả về số thêm / bỏ qua.
 */
